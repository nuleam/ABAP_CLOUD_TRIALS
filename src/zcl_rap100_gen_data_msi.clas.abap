CLASS zcl_rap100_gen_data_MSI DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_MSI IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'MSI',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravMSI.
    DELETE FROM zrap100_dtravMSI.

    "insert travel demo data
    INSERT zrap100_atravMSI  FROM (
        SELECT
